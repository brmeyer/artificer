    ...
    public List<ReverseRelationship> reverseRelationships(final String uuid) throws ArtificerException {
            ...
            protected List<ReverseRelationship> doExecute(EntityManager entityManager) throws Exception {
                Query q = entityManager.createQuery(
                        "SELECT new org.artificer.common.query.ReverseRelationship(r.name, r.type, a1.uuid, a1.name, a1.description, a1.model, a1.type)" +
                ...
                q = entityManager.createQuery(
                        "SELECT new org.artificer.common.query.ArtifactSummary(a.uuid, a.name, a.description, a.model, a.type)" +
