package org.artificer.ide.eclipse.plugin.commands;

import org.artificer.ide.eclipse.plugin.dialogs.ViewMain;
...
public class RepositoryBrowser extends ViewPart {
	 ...
	 */
	public static final String ID = "org.artificer.ide.eclipse.views.RepositoryBrowser";
