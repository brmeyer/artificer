...
databases: Postgres, MySQL/MariaDB, Oracle, SQL Server, and DB2/IBM.  In addition, H2 is included (the default DB
in Wildfly/EAP).

For now, you'll need to manually set up the database using the provided DDL.  Once installed, be sure to update the
